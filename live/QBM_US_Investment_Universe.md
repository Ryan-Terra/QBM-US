...
First application of the new 1.5x-depth rule: the next 18 companies below the original 36-company cutoff (by the identical composite ranking) — full detail: [screens/QBM_US_Discovery_2026-08-20_TechServicesExpanded.md](../screens/QBM_US_Discovery_2026-08-20_TechServicesExpanded.md), raw data: [QBM_US_TechServices_2026-08-20_expanded_longlist.csv](../screens/QBM_US_TechServices_2026-08-20_expanded_longlist.csv). **15 eligible after thematic screening** (EPAM and PLUS excluded on AI-infrastructure grounds; PATH re-affirmed excluded, not part of the organic ranked tier). **Discovery-only — no Mini QBM or Full QBM has been run on any of these; whether to advance them is a decision for investor review.**

| Company ID | Company | Ticker | Sub-Industry | Cohort | Record status |
|---|---|---|---|---|---|
| QBM-US-COMP-NOVT | Novanta Inc. | NOVT | Electronic Equipment & Instruments | Profitable | Complete (Discovery only, rank 38) |
| QBM-US-COMP-BL | BlackLine, Inc. | BL | Application Software | Profitable | Complete (Discovery only, rank 40) |
| QBM-US-COMP-MIR | Mirion Technologies | MIR | Electronic Equipment & Instruments | Profitable | Complete (Discovery only, rank 41) |
| QBM-US-COMP-BHE | Benchmark Electronics | BHE | Electronic Manufacturing Services | Profitable | Complete (Discovery only, rank 42) — AI-adjacent customer exposure noted, not excluded |
| QBM-US-COMP-DBD | Diebold Nixdorf | DBD | Electronic Equipment & Instruments | Profitable | Complete (Discovery only, rank 43) |
| QBM-US-COMP-SCSC | ScanSource, Inc. | SCSC | Technology Distributors | Profitable | Complete (Discovery only, rank 44) |
| QBM-US-COMP-VSH | Vishay Intertechnology | VSH | Electronic Components | Profitable | Complete (Discovery only, rank 45) |
| QBM-US-COMP-IPGP | IPG Photonics | IPGP | Electronic Manufacturing Services | Profitable | Complete (Discovery only, rank 46) — forward-looking AI-datacenter angle noted, not yet material |
| QBM-US-COMP-CXM | Sprinklr, Inc. | CXM | Application Software | Profitable | Complete (Discovery only, rank 47) |
| QBM-US-COMP-BILL | BILL Holdings | BILL | Application Software | Profitable | Complete (Discovery only, rank 48) |
| QBM-US-COMP-ROG | Rogers Corporation | ROG | Electronic Components | Profitable | Complete (Discovery only, rank 49) |
| QBM-US-COMP-CRSR | Corsair Gaming | CRSR | Technology Hardware, Storage & Peripherals | Profitable | Complete (Discovery only, rank 50) |
| QBM-US-COMP-VYX | NCR Voyix | VYX | IT Consulting & Other Services | Profitable | Complete (Discovery only, rank 51) |
| QBM-US-COMP-EFOR | Everforth, Inc. (fka ASGN Inc.) | EFOR | IT Consulting & Other Services | Profitable | Complete (Discovery only, rank 52) — yfinance metadata stale (blank company name), confirmed real via web search |
| QBM-US-COMP-DXC | DXC Technology | DXC | IT Consulting & Other Services | Profitable | Complete (Discovery only, rank 53) — internal-use AI cost-reduction noted, not excluded |
