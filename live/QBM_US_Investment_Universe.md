...
| QBM-US-COMP-BHE | Benchmark Electronics | BHE | Electronic Manufacturing Services | Profitable | **Mini QBM complete — Advance to Full QBM** (AI-adjacent EMS customer exposure, not excluded; clean red-flag scan) |
...
| QBM-US-COMP-SCSC | ScanSource, Inc. | SCSC | Technology Distributors | Profitable | **Mini QBM complete — Advance to Full QBM** (genuine beat-and-raise recovery from a Feb 2026 guidance cut; dated MicroAge M&A catalyst; 52-week-high data conflict flagged for Full QBM) |
...
| QBM-US-COMP-ROG | Rogers Corporation | ROG | Electronic Components | Profitable | **Mini QBM complete — Advance to Full QBM** (disclosed AI-thermal product pipeline in customer validation; guidance raise; clean red-flag scan; note the already-large +92% 1yr re-rating) |
