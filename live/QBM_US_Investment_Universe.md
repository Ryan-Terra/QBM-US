...
| QBM-US-COMP-BHE | Benchmark Electronics | BHE | Electronic Manufacturing Services | Profitable | **Full QBM complete 21 Aug — Add. Ready.** 8.04% insider ownership (Mid, clears), immaterial selling, 27.0% below 52-week high, -14.7% vs. avg analyst target. Bench, no target-portfolio slot. |
...
| QBM-US-COMP-ROG | Rogers Corporation | ROG | Electronic Components | Profitable | **Full QBM complete 21 Aug — Add. Ready.** 5.78% insider ownership (Mid, clears); CEO chose not to sell beyond mandatory tax withholding; ~20-25% below 52-week high; ~22-27% discount to avg analyst target. Bench, no slot. |
