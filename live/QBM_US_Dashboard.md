...
Assessment evidence current through: 19 August 2026 Full QBM (small/mid-cap Health Care) + Target Holding Period review  
Current macro evidence through: 14 August 2026 (CMEA-US-2026-08-14-001)  
Methodology updated: 19 August 2026 (v1.9 — Universe Filter floor lowered to $300M; Health Care fully exempted and Electronic Technology/Technology Services partially exempted from Quantitative Pre-Screen profitability gates; Target Holding Period, Entry-Point Discipline and a Position Sizing Framework, since replaced by discrete Portfolio Concentration tiers, added to Full QBM)  
Investment Charter updated: 19 August 2026 (v1.3 — 6-18 month Target Holding Period per position; Entry-Point Discipline; Portfolio Concentration — 5-8 holdings, 10-20% each)  
Full-system synchronisation confirmed: 19 August 2026 — this reconciliation pass  
...
Governing authority: [QBM-US Investment Charter](../framework/QBM_US_Investment_Charter.md) — Version 1.5; permanent; amended 20 August 2026.
...
| QBM-US Methodology Version | 1.19 |
...
| Item | Current status |
|---|---|
| Current Committee Position | Full QBM complete on 9 general-funnel finalists (14 Aug), 11 small/mid-cap Health Care finalists (19 Aug) and 15 Tech Services finalists (20 Aug, 11 Add after all four update passes); **21 Add decisions stand**, of which **6 hold a slot in the concentrated target portfolio** (MA, LLY, VCYT, PTCT, XNCR, ACAD) and **15 sit on the bench** (NEO, HRMY, KRYS, HQY + BDC, NTCT, CTS, AGYS, DLB, CNXN, DGII, PI, KN, ARLO, PLXS); no capital deployed yet |
| Current Committee Action | **None — cash** (target portfolio constructed but awaits investor-specified deployable capital) |
| Investment Decision | **Add — in target portfolio:** MA 20% · LLY 15% · VCYT 15% · PTCT 15% · XNCR 15% · ACAD 10%. **Add — benched:** NEO, HRMY, KRYS, HQY. **Continue Monitoring:** HALO, AAPL, LGND, CON, INVA. **Excluded — investor preference (AI exposure):** NVDA/LRCX/AVGO/GOOGL/KLAC |
| Implementation Readiness | **Ready with Considerations:** PTCT. **Await Better Entry:** MA, LLY, VCYT, XNCR, ACAD (all five are in the target portfolio but not yet a good entry — MA and XNCR both corrected 20 Aug 2026 under the new ATH Proximity Rule), plus benched NEO/HRMY/KRYS/HQY. **No holding is currently rated Ready.** See [ATH Rule](../screens/QBM_US_ATHRule_2026-08-20.md) and [Entry-Point Review](../screens/QBM_US_EntryPointReview_2026-08-19.md) |
| Implementation Notes | 14 Aug Full QBM referenced Standing CMEA CMEA-US-2026-08-14-001; same-day Thematic Exclusion removed NVDA/LRCX/AVGO/GOOGL/KLAC. 19 Aug: Charter amended for Target Holding Period, Entry-Point Discipline, then **Portfolio Concentration** (v1.3) — investor directed 5-8 holdings, 10-20% each, "go hard or go home." 6 of 10 standing Adds selected into a 100%-invested target book; see [Concentrated Portfolio construction](../screens/QBM_US_ConcentratedPortfolio_2026-08-19.md). Still 100% cash; no purchase has occurred. |
| Tier 1 Companies | 5 (LLY, MA, VCYT, PTCT — in the target portfolio; NEO — benched) |
| Tier 2 Companies | 6 (HALO, AAPL — Continue Monitoring; XNCR, ACAD — in target portfolio; HRMY, KRYS — benched) |
...
No current holdings. **Ten** Full QBM Add decisions stand, but no capital has been deployed — the investor has not yet specified deployable cash. NVDA's original Add decision was superseded by the Thematic Exclusion, not by any quality finding.
...
| QBM-US-COMP-PTCT | — (recommended, not held) | 0 | Add | Ready with Considerations | **15%** | 0.00% | Underweight |
| QBM-US-COMP-XNCR | — (recommended, not held) | 0 | Add | Await Better Entry (corrected 20 Aug) | **15%** † | 0.00% | Underweight |
| QBM-US-COMP-ACAD | — (recommended, not held) | 0 | Add | Await Better Entry | **10%** † | 0.00% | Underweight |
| QBM-US-COMP-NEO | Bench — not in the 6 | 0 | Add | Await Better Entry | Not applicable | 0.00% | — |
| QBM-US-COMP-HRMY | Bench — not in the 6 | 0 | Add | Await Better Entry | Not applicable | 0.00% | — |
| QBM-US-COMP-KRYS | Bench — not in the 6 | 0 | Add | Await Better Entry | Not applicable | 0.00% | — |
| QBM-US-COMP-HQY | Bench — not in the 6 | 0 | Add | Await Better Entry | Not applicable | 0.00% | — |
| — | Deployable cash | — | — | — | — | 100.00% | — |

† XNCR and ACAD each carry a **binary near-term catalyst** (a single Phase 3 dose readout and a single Phase 2 readout respectively) — disclosed explicitly, not netted into the tier assignment. Together they're 25% of the target portfolio.

**Portfolio Concentration instruction from the investor (19 Aug 2026, Charter v1.3):** 5-8 holdings, no position below 10%, sized in 10/15/20% discrete tiers — "go hard or go home." This replaced the continuous position-sizing bands from earlier the same day and required an explicit selection: **6 of the 10 standing Adds got a slot; NEO, HRMY, KRYS and HQY did not** (each remains Add-rated — bench, not rejected). Full construction, the binary-catalyst disclosure, and rotation triggers for the bench four: [screens/QBM_US_ConcentratedPortfolio_2026-08-19.md](../screens/QBM_US_ConcentratedPortfolio_2026-08-19.md).

**Sector concentration is now sharper, not smaller:** 5 of 6 holdings (85% of the target portfolio) are Health Care/pharma-biotech — only MA sits outside. Concentrating to 6 names compressed the existing sector tilt into fewer, larger positions rather than reducing it.

Target portfolio sums to exactly **100%** — fully invested across 6 names once capital is deployed. **Corrected 20 Aug 2026, twice over:** XNCR was wrongly recorded as Ready on 19 Aug (an incorrect trailing-return figure; actually +178.71%/yr, within 1% of its 52-week high), which prompted the new [ATH Proximity Rule](../framework/QBM_US_Investment_Charter.md#ath-proximity-rule-added-v14-20-august-2026) — and applying that rule found **MA also fails it** (4.26% below its own all-time high). **As of 20 Aug 2026, no target holding is Ready; only PTCT (15%) retains Ready with Considerations.** The remaining 85% (MA, LLY, XNCR, VCYT, ACAD) is a real destination, not a today-trade.

**Portfolio Investment Decision:** Add LLY, MA, VCYT, NEO, PTCT, XNCR, ACAD, HRMY, KRYS, HQY (once deployable capital is specified).  
**Implementation Readiness (revised 20 Aug 2026 — ATH Proximity Rule, Charter v1.5, 10% threshold):** Ready with Considerations — PTCT only. **Await Better Entry — MA, LLY, NEO, VCYT, XNCR, ACAD, HRMY, KRYS, HQY.** MA and XNCR were both corrected on 20 Aug: XNCR was wrongly rated Ready on an incorrect trailing-return figure (actually +178.71%/yr), and applying the resulting hard rule (no Ready rating within 10% of a 52-week/all-time high) found MA also fails it (4.26% below its all-time high). **No holding is currently Ready.** See [ATH Rule](../screens/QBM_US_ATHRule_2026-08-20.md) and [Entry-Point Review](../screens/QBM_US_EntryPointReview_2026-08-19.md).  
**Implementation Notes:** Portfolio is 100% cash. Deployable capital amount not yet specified by the investor — no unit quantities, weights or execution timing can be set until it is. **Sector concentration disclosed:** 9 of the 10 Adds are Health Care (8 of those small/mid-cap); only MA sits outside the sector — a real, correlated exposure to weigh at sizing time. **Only PTCT currently clears the ATH Proximity Rule for a Ready-adjacent status** — the rest of the target book is a real destination, not a today-trade.
...
**Rankings are now the 6-holding target portfolio itself** (Portfolio Concentration, Charter v1.3, 19 Aug 2026) — 5-8 holdings, 10-20% each, "go hard or go home." Ranked by target weight; within the target portfolio, Implementation Readiness still governs execution order (Ready first).

### Target portfolio (6 holdings, 100% invested)

| Rank | Company ID | Company | Weight | Implementation Readiness | Reason for position |
|---:|---|---|---:|---|---|
| 1 | QBM-US-COMP-MA | Mastercard (MA) | **20%** | Await Better Entry (corrected 20 Aug — 4.26% below its all-time high) | Durable duopoly moat; two dated near-term catalysts (BVNK close, settlement progress) still ahead of it, not behind it — Core conviction on quality, but the ATH Proximity Rule (Charter v1.5, 10% threshold) means the entry itself must wait |
...
| 4 | QBM-US-COMP-PTCT | PTC Therapeutics (PTCT) | **15%** | Ready with Considerations | Three independent revenue sources — real diversification within one name; litigation status and a conflicting analyst target still need confirming. |
| 5 | QBM-US-COMP-XNCR | Xencor (XNCR) | **15%** † | Ready | Validated multi-partner platform and diversified royalty income, but the Add catalyst is a single Phase 3 dose readout (2H 2026) — binary, disclosed, not netted away. |
| 6 | QBM-US-COMP-ACAD | ACADIA Pharmaceuticals (ACAD) | **10%** † | Await Better Entry | Two approved, growing products provide a real base, but the Add catalyst is a single Phase 2 readout (Sept-Oct 2026) — binary, sized at the floor because of it. |

† XNCR + ACAD = 25% of the portfolio riding partly on a single binary event each. Disclosed explicitly per Charter v1.3, not averaged into the Add rating. Full construction, sector-concentration note (85% Health Care) and execution sequencing: [Concentrated Portfolio construction](../screens/QBM_US_ConcentratedPortfolio_2026-08-19.md).
...
| QBM-US-COMP-KRYS | Krystal Biotech (KRYS) | Single-product (VYJUVEK) concentration plus a binary early-2027 readout | A positive EMERALD-1 readout |
...
| QBM-US-COMP-BDC | Belden (BDC) | Cleanest of the Tech Services 11 (no confidence discount) — simply awaits an open slot | Strongest candidate for the next available slot |
| QBM-US-COMP-CNXN | Connection (CNXN) | Multi-officer material selling; narrow (11.1%) ATH clearance | Wider ATH clearance |
| QBM-US-COMP-DLB | Dolby Laboratories (DLB) | Borderline/unconfirmed 6-month selling total; live-price confirmation still needed | Live price confirmation |
| QBM-US-COMP-AGYS | Agilysys (AGYS) | Multi-officer concentrated selling; genuine current-price data conflict ($65-$108) | Price conflict resolved |
...
| QBM-US-COMP-PLXS | Plexus (PLXS) | Near-miss ownership (1.78% vs. 2%); severe recent selling ($5.4M/90 days); narrow (10.85%) ATH clearance | Wider ATH clearance + selling normalizes |
| QBM-US-COMP-NTCT | NetScout Systems (NTCT) | Fails the ATH rule (7.1% below high, sharp trailing-year run) | Pullback clearing the 10% ATH band |
| QBM-US-COMP-DGII | Digi International (DGII) | Fails the ATH rule outright (trading above its own stated 52-week high) | Pullback below its 52-week high |
| QBM-US-COMP-KN | Knowles (KN) | Near-miss ownership (1.7% vs. 2%); fails the ATH rule (~3% below high) | Pullback clearing the 10% ATH band |
| QBM-US-COMP-CTS | CTS Corporation (CTS) | Material CEO-only selling ($8.48M, zero buys); fails the ATH rule | ATH clearance + selling pattern normalizes |
...
|---|---|---|---|---|
| Portfolio | Not applicable | **No current holdings — 100% cash; 6-holding target portfolio constructed, pending capital** | **Not Applicable** | — |
...
| Target portfolio | QBM-US-COMP-PTCT | Add — 15% | Ready with Considerations | Add |
| Target portfolio | QBM-US-COMP-XNCR | Add — 15% (binary catalyst) | Ready | Add |
| Target portfolio | QBM-US-COMP-ACAD | Add — 10% (binary catalyst) | Await Better Entry | Add |
| Bench (Add, no slot) | QBM-US-COMP-NEO, HRMY, KRYS, HQY | Add — not applicable (see rotation triggers, Section 8) | Await Better Entry | Add |
...
| QBM-US-COMP-PTCT | PTC Therapeutics | Add | 15% | Ready with Considerations |
| QBM-US-COMP-XNCR | Xencor | Add | 15% | Ready |
| QBM-US-COMP-ACAD | ACADIA Pharmaceuticals | Add | 10% | Await Better Entry |
| — | Deployable cash | Not Applicable | — | Not Applicable |

No equity positions are currently held — the 6-holding target portfolio awaits investor-specified deployable capital. NEO, HRMY, KRYS and HQY remain Add-rated but hold no target weight (benched — see Section 8).
...
| Concentration Risk | **Deliberately high, by investor instruction (Charter v1.3), and sharper than before:** the target portfolio is 6 holdings at 10-20% each. **5 of 6 (85%) are Health Care/pharma-biotech** — only MA sits outside. **2 of 6 (XNCR 15%, ACAD 10% — 25% combined) carry a single binary near-term catalyst.** A sector-wide shock or one failed binary readout each has materially more effect on total portfolio outcome than in a diffuse portfolio — this is the explicit trade-off the investor chose, not an oversight, but it must stay visible here, not softened. |
| Implementation Notes | No open positions; 6-holding target portfolio (100% invested) awaits investor-specified deployable capital; **as of 20 Aug 2026 (ATH Proximity Rule), no holding is Ready — only PTCT (15%) retains Ready with Considerations** |
...
|---|---|
| Diversification | Not applicable while 100% cash; **if funded as recommended, the 10 Add positions would span only 2 sectors, 9 of them Health Care** — a real, disclosed concentration for the investor to weigh, not resolved by QBM-US itself |
...
- Operating-system release: QBM-US Version 1.19
- **This reconciliation (20 Aug 2026, methodology-recommendations pass, complete):** Four new rules built and all four fully applied — Insider Ownership near-miss provision (v1.16: KN/ARLO/PLXS now Advance), Discovery longlist depth-widening (v1.17: Tech Services widened 36→54, 15 new Discovery-eligible names found, none yet Mini QBM'd), Mini QBM Red-Flag Adverse-Event Scan (v1.18, policy only — no retroactive companies to re-check since RAL/CVLT already demonstrate its premise), Valuation Ceiling (v1.19/Charter v1.6: applied to all 21 standing Adds, 20 pass, 0 fail, CTS a disclosed data gap). Tech Services Full QBM final tally revised to 11 of 15 Add; bench now 15 candidates; 15 further names sit at Discovery-only awaiting an investor decision on whether to advance them. Not yet reconciled: Sections 4-6's detailed coverage-funnel counts (companies tracked, Full QBM completed, Discovery longlist totals) still reflect the pre-Tech-Services state — flagged here as a known gap rather than silently left inconsistent.
