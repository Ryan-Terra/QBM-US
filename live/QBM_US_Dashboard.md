...
Methodology updated: 21 August 2026 (v1.21 — near-miss Insider Ownership provision, Discovery longlist depth-widening, Mini QBM Red-Flag Adverse-Event Scan, Valuation Ceiling, Insider Buying positive factor, Evidence Staleness Re-verification Requirement)  
...
| QBM-US Methodology Version | 1.21 |
...
| Operating-System Release | **QBM-US Version 1.21** |
...
| QBM-US-COMP-KN | Knowles (KN) | Near-miss ownership (1.7% vs. 2%); fails the ATH rule (~3% below high); ~$9M selling partially offset by a genuine ~$423K insider buy (v1.20), doesn't change the rating | Pullback clearing the 10% ATH band |
